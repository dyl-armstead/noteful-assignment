// want to POST a new note entry in a specific folder to the server, then rerender the note list of that folder
// a user should be able to cancel adding a note
/* adding a new note should: 
    - require a name note name and note content from the user, and create a new id inside of the correct folder id
    - the note should appear in the list main, the modified date should be correct, and the folder number should increase
*/
